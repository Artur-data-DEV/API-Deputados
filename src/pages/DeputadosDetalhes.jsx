            ...
            {deputados.id &&
                <>
                    <Row className="Row1">
                        ...
                        <Col md={8} className="Col2"style={{backgroundColor:"black"}} >
                            
                            <Cartao >
                                <h1 style={{textAlign:"center"}}>{deputados.nomeCivil} </h1>
                                ...
                                <a href={`/partidos/${idPartido}`}><img src={!partido.urlLogo? "Carregando..." : partido.urlLogo} alt="Logo partido" /></a>                            </Cartao>
                            <br/>
                            <Cartao >
